...
import com.jln.common.web.shiro.AnyRolesAuthorizationFilter;
...
/*
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean() {
        ...
        shiroFilter.setUnauthorizedUrl("/user/toShrioError");
        */
/*
         * c. 添加jwt过滤器，并在下面注册
        ...
        filterRuleMap.put("/testRoles", "roles[admin]");
